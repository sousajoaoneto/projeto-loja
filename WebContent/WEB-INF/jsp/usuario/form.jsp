...
<section id="form">
	<div class="container">
		...
		<div class="col-sm-6">
			...
			<form class="form-horizontal light cadUser"
				action="${pageContext.request.contextPath}/usuario/salvar"
				method="post">
				<div class="form-group has-feedback">
					<div class="col-sm-12">
						<input type="text" class="form-control" id="firstName"
							placeholder="Nome" name="usuario.nome" autofocus required /> <span
				...
				<div class="form-group has-feedback">
					<div class="col-sm-6">
						<input type="text" class="form-control" id="cpf"
							name="usuario.cpf" placeholder="CPF" required /> <span
							class="glyphicon glyphicon-hand-left form-control-feedback"></span>
					</div>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="birth"
							name="usuario.data_nasc" placeholder="Data NAscimento" required />
				...
				<div class="form-group has-feedback">
					<div class="col-sm-3">
						<input type="text" class="form-control cep" id="cep"
							name="cidade.cep" placeholder="CEP" required />
					</div>
					<div class="col-sm-3">
						<input type="text" class="form-control uf" id="state"
							name="estado.nome" placeholder="UF" required />
					</div>
					<div class="col-sm-6">
						<input type="text" class="form-control cidade" id="city"
							placeholder="Cidade" name="cidade.nome" required /> <span
				...
				<div class="form-group has-feedback">
					<div class="col-sm-12">
						<input type="email" class="form-control" id="email2"
							name="usuario.email" placeholder="E-mail" required /> <span
				...
				<div class="form-group has-feedback">
					<div class="col-sm-12">
						<input type="password" class="form-control" id="password2"
							name="usuario.senha" placeholder="Senha" required /> <span
