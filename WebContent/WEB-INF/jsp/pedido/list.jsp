				...
				<c:otherwise>
					<c:forEach items="${pedidos}" var="pedido">
						<div class="item" data-item="${pedido.id_pedido}">
							<div class="item-img"
								style="background: url(${pageContext.request.contextPath}/theme/images/pedido.jpg) no-repeat;"></div>
							<div class="item-content">
								<h3>
									<a href="#">Pedido - ${pedido.id_pedido}</a>
								</h3>
								<div class="item-etapa">
									<div class="corpo_etapa ">
										<div class="etapa concluido">
									...
									<div class="corpo_etapa">
										<div class="etapa"><span class="glyphicon glyphicon-remove"></span></div>
